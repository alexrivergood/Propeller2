//Uses several cogs for multiplication and operations
//Inference: 440 ms
//Inference int16x16: 110 ms
                        ...
                        for (int ky = 0; ky < 3; ++ky) {
                            for (int kx = 0; kx < 3; ++kx) {
                                ...
                                if (iy >= 0 && iy < IN_H && ix >= 0 && ix < IN_W) {
                                    ...
                                    sum += s->img[iy][ix] * conv2d_weights[w_idx];
                                }
                            }
                        }
                            ...
                            for (int kx = 0; kx < 3; ++kx) {
                                ...
                                if (iy >= 0 && iy < C1_H && ix >= 0 && ix < C1_W) {
                                    for (int ic = 0; ic < C1_OUT; ++ic) {
                                        ...
                                        sum += s->c1_out[in_idx] * conv2d_1_weights[w_idx];
                                    }
                                }
                            }
                        }
                            ...
                            for (int kx = 0; kx < 3; ++kx) {
                                ...
                                if (iy >= 0 && iy < C2_H && ix >= 0 && ix < C2_W) {
                                    for (int ic = 0; ic < C2_OUT; ++ic) {
                                        ...
                                        sum += s->c2_out[in_idx] * conv2d_2_weights[w_idx];
                                    }
                                }
                            }
                        }
                            ...
                            for (int kx = 0; kx < 3; ++kx) {
                                ...
                                if (iy >= 0 && iy < C3_H && ix >= 0 && ix < C3_W) {
                                    for (int ic = 0; ic < C3_OUT; ++ic) {
                                        ...
                                        sum += s->c3_out[in_idx] * conv2d_3_weights[w_idx];
                                    }
                                }
                            }
                        }
...
int main() {
    ...
    for (int o = 0; o < DENSE_OUT; ++o) {
        ...
        for (int i = 0; i < GAP_OUT; ++i) {
            ...
            sum += NN.gap[i] * dense_weights[weight_idx];
        }
        NN.out[o] = sum;
    }
