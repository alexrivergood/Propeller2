// =============================================================================
// bench_320kb.c  --  CNN Layer Parallelization Benchmark  (320kb model)
// =============================================================================
...
int main(void) {
    ...
    static const char *phase_dims[6] = {
        "22ch x 28x28  in=1ch", "44ch x 14x14  stride=2", "44ch x 14x14  stride=1", "44ch x 7x7    stride=2", "44ch -> 44", "44 -> 10"
    };
