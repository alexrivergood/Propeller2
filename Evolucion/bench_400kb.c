// =============================================================================
// bench_400kb.c  --  CNN Layer Parallelization Benchmark  (400kb model)
// =============================================================================
...
int main(void) {
    ...
    static const char *phase_dims[6] = {
        "26ch x 28x28  in=1ch", "52ch x 14x14  stride=2", "52ch x 14x14  stride=1", "52ch x 7x7    stride=2", "52ch -> 52", "52 -> 10"
    };
