...
#include "165kb_weights.h"
#include "mnist_sample.h"

#define MODEL_NAME    "165kb"
#define STACKSIZE     4096
#define WBUF_MAX_SIZE 252
...
// per layer to tune parallelism.  Run bench_165kb.c on hardware first to
...
static const LayerDesc LAYER_PROFILE[6] = {
    {7, 1},  // Conv1  (14 output channels, 28x28)
    {7, 1},  // Conv2  (28 output channels, 14x14, stride 2)
    {7, 1},  // Conv3  (28 output channels, 14x14)
    {7, 1},  // Conv4  (28 output channels, 7x7, stride 2)
    {7, 1},  // GAP    (28 channels)
    {3, 1},  // Dense  (28 -> 10)
};
