...
// per layer to tune parallelism.  Run bench_320kb.c on hardware first to
...
static const LayerDesc LAYER_PROFILE[6] = {
    {7, 1},  // Conv1  (22 output channels, 28x28)
    {7, 1},  // Conv2  (44 output channels, 14x14, stride 2)
    {7, 1},  // Conv3  (44 output channels, 14x14)
    {7, 1},  // Conv4  (44 output channels, 7x7, stride 2)
    {7, 1},  // GAP    (44 channels)
    {7, 1},  // Dense  (44 -> 10)
};
