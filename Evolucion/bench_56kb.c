// =============================================================================
// bench_56kb.c  --  CNN Layer Parallelization Benchmark  (56kb model)
// =============================================================================
...
int main(void) {
    ...
    static const char *phase_dims[6] = {
        "6ch x 28x28  in=1ch", "12ch x 14x14  stride=2", "12ch x 14x14  stride=1", "12ch x 7x7    stride=2", "12ch -> 12", "12 -> 10"
    };
