// =============================================================================
// bench_165kb.c  --  CNN Layer Parallelization Benchmark  (165kb model)
// =============================================================================
...
int main(void) {
    ...
    static const char *phase_dims[6] = {
        "14ch x 28x28  in=1ch", "28ch x 14x14  stride=2", "28ch x 14x14  stride=1", "28ch x 7x7    stride=2", "28ch -> 28", "28 -> 10"
    };
