...
#include "400kb_weights.h"
#include "mnist_sample.h"

#define MODEL_NAME    "400kb"
#define STACKSIZE     4096
#define WBUF_MAX_SIZE 468
...
// per layer to tune parallelism.  Run bench_400kb.c on hardware first to
...
static const LayerDesc LAYER_PROFILE[6] = {
    {7, 1},  // Conv1  (26 output channels, 28x28)
    {7, 1},  // Conv2  (52 output channels, 14x14, stride 2)
    {7, 1},  // Conv3  (52 output channels, 14x14)
    {7, 1},  // Conv4  (52 output channels, 7x7, stride 2)
    {7, 1},  // GAP    (52 channels)
    {7, 1},  // Dense  (52 -> 10)
};
