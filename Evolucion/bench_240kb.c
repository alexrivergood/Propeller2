// =============================================================================
// bench_240kb.c  --  CNN Layer Parallelization Benchmark  (240kb model)
// =============================================================================
...
int main(void) {
    ...
    static const char *phase_dims[6] = {
        "18ch x 28x28  in=1ch", "36ch x 14x14  stride=2", "36ch x 14x14  stride=1", "36ch x 7x7    stride=2", "36ch -> 36", "36 -> 10"
    };
